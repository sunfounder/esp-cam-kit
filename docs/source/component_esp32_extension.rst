...
さらに、単一の3.7V バッテリーを使用してプロジェクトに電力を供給できます。バッテリーが低下した場合でも、5V Micro USBケーブルを接続するだけで簡単に充電できます。これにより、屋外プロジェクトやリモートアプリケーションに最適です。
...
* **バッテリーポート**
    * PH2.0-2Pインターフェースを備え、3.7Vのリチウムバッテリーに対応。
